...
class StatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAllOnlineUsers = channel.unary_unary(
                ...
                request_serializer=command__pb2.GetAllOnlineUsersRequest.SerializeToString,
                response_deserializer=command__pb2.GetAllOnlineUsersResponse.FromString,
                _registered_method=True)
...
def add_StatsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAllOnlineUsers': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=command__pb2.GetAllOnlineUsersRequest.FromString,
                    response_serializer=command__pb2.GetAllOnlineUsersResponse.SerializeToString,
            ),
    }
...
class StatsService(object):
    ...
    def GetAllOnlineUsers(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/xray.app.stats.command.StatsService/GetAllOnlineUsers',
            command__pb2.GetAllOnlineUsersRequest.SerializeToString,
            command__pb2.GetAllOnlineUsersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
