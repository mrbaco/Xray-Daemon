...
class ServerConfig(_message.Message):
    __slots__ = ("auth_type", "accounts", "address", "udp_enabled", "user_level")
    ...
    udp_enabled: bool
    user_level: int
    def __init__(self, auth_type: _Optional[_Union[AuthType, str]] = ..., accounts: _Optional[_Mapping[str, str]] = ..., address: _Optional[_Union[_address_pb2.IPOrDomain, _Mapping]] = ..., udp_enabled: bool = ..., user_level: _Optional[int] = ...) -> None: ...
